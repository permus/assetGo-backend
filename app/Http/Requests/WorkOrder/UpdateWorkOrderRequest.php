...
class UpdateWorkOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'type' => 'sometimes|required|in:ppm,corrective,predictive,reactive',
    ...
    public function messages()
    {
        return [
            ...
            'type.in' => 'Selected work order type is invalid. Must be one of: PPM, Corrective, Predictive, or Reactive.',
